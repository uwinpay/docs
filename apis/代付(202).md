...
|代付类型|bank_code|String|是|BANK|示例中的固定值|
|账户号码|account_number|String|是|56432545555|收款账户号码|
|账户编码|account_code|String|否|KKBK0000123|大写ifsc码|
...
```json
{
    ...
    "merchant_order_no": "20230220171350901582",
    "pay_type": "202",
    "currency": "INR",
    "name": "test",
    "mobile": "8711111111",
    ...
    "sign": "8ce59d50673eb3ccb7ec8a60e02d40d5"
}
```
