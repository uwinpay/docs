...
| 印度 | [201](代收(dd).html)&nbsp;&nbsp; [202](代收(wd).html)&nbsp;&nbsp; [203](代收(203).html)&nbsp;&nbsp; [204](代收(204).html)&nbsp;&nbsp; [205](代收(205).html)&nbsp;&nbsp; [206](代收(206).html)|
...
|支付通道编码|pay_type|String|是|rb|示例中固定值|
...
```json
{
    ...
    "merchant_order_no": "20230210144425015542",
    "pay_type": "rb",
    "currency": "PHP",
    "name": "test",
    "mobile": "09456312891",
    ...
    "amount": "100.00",
    "notify_url": "https:\/\/www.uwinpay.com\/api\/public\/index.php\/pay_notify",
    "page_url": "https:\/\/www.uwinpay.com\/api\/public\/index.php\/pay_return",
    "order_time": 1676011465,
    "sign": "c6f065f4dd395868f5ed05f6fd5fea77"
}
```
...
```json
{
    ...
    "data": {
        ...
        "pay_data": "",
        "order_no": "20230210144430394179",
        "order_time": 1676011472,
        "sign": "10c1452ba6660aff1a122e7e45b04272"
    },
    "msg": "ok"
}
```
